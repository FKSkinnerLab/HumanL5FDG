...
## gIhbar_Ih = 0 TO REPRESENT ZERO IH FROM 0.0002 THE DEFAULT CONDUCTANCE VALUE in L5PCbiophys3.hoc file in models folder for line 34
...
for i in range(1,31): 
	...
	noisenames1 = 'STAHayDC0.38_noisefile' + str(i)+ '_zeroIh'
