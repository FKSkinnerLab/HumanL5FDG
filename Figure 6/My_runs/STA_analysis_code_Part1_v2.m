for Z = 1:30
	...
	namefornoise = 'STA_HayDC0.38_noisefile'+ string(Z) + '_normalIh.csv';
	namenoise = 'Hay_normalIh' + string(Z)+ string(noisenamebasis);
    ...
    %Creating time vector specific to the AP (action potential; spikes) by enclosing only membrane voltage > -55 (threshold)
    ...
    pK_Pst_trace = zeros(length(time2),6000);
    pK_Tst_trace = zeros(length(time2),6000);
    pSK_E2_trace = zeros(length(time2),6000);
    pSKv3_1_trace = zeros(length(time2),6000);
    pIm_trace = zeros(length(time2),6000);
    ppas_trace = zeros(length(time2),6000);
    pCa_HVA_trace = zeros(length(time2),6000);
    pCa_LVAst_trace = zeros(length(time2),6000);
    pNaTa_t_trace = zeros(length(time2),6000);
    pNap_Et2_trace = zeros(length(time2),6000);
    pIh_trace = zeros(length(time2),6000);
    Noise_trace = zeros(length(time2),6000);
    
    
    pK_Pst_avg = zeros(1,6000);
    pK_Tst_avg = zeros(1,6000);
    pSK_E2_avg = zeros(1,6000);
    pSKv3_1_avg = zeros(1,6000);
    pIm_avg = zeros(1,6000);
    ppas_avg = zeros(1,6000);
    pCa_HVA_avg = zeros(1,6000);
    pCa_LVAst_avg = zeros(1,6000);
    pNaTa_t_avg = zeros(1,6000);
    pNap_Et2_avg = zeros(1,6000);
    pIh_avg = zeros(1,6000);
    pNoise_avg = zeros(1,6000);
    
    pK_Pst_std = zeros(1,6000);
    pK_Tst_std = zeros(1,6000);
    pSK_E2_std = zeros(1,6000);
    pSKv3_1_std = zeros(1,6000);
    pIm_std = zeros(1,6000);
    ppas_std = zeros(1,6000);
    pCa_HVA_std = zeros(1,6000);
    pCa_LVAst_std = zeros(1,6000);
    pNaTa_t_std = zeros(1,6000);
    pNap_Et2_std = zeros(1,6000);
    pIh_std = zeros(1,6000);
    pNoise_std = zeros(1,6000);
