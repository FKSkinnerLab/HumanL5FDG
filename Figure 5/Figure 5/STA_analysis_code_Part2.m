pK_Pst_finalavg = zeros(1,20000);
pK_Tst_finalavg = zeros(1,20000);
pSK_E2_finalavg = zeros(1,20000);
pSKv3_1_finalavg = zeros(1,20000);
pIm_finalavg = zeros(1,20000);
ppas_finalavg = zeros(1,20000);
pCa_HVA_finalavg = zeros(1,20000);
pCa_LVAst_finalavg = zeros(1,20000);
pNaTa_t_finalavg = zeros(1,20000);
pNap_Et2_finalavg = zeros(1,20000);
pIh_finalavg = zeros(1,20000);
pNoise_finalavg = zeros(1,20000);

pK_Pst_finalstd = zeros(1,20000);
pK_Tst_finalstd = zeros(1,20000);
pSK_E2_finalstd = zeros(1,20000);
pSKv3_1_finalstd = zeros(1,20000);
pIm_finalstd = zeros(1,20000);
ppas_finalstd = zeros(1,20000);
pCa_HVA_finalstd = zeros(1,20000);
pCa_LVAst_finalstd = zeros(1,20000);
pNaTa_t_finalstd = zeros(1,20000);
pNap_Et2_finalstd = zeros(1,20000);
pIh_finalstd = zeros(1,20000);
pNoise_finalstd = zeros(1,20000);
...
for Z = 1:30
	...
	namefornoise = '200ms_K_Pstnormal_IhIm_0.025' + string(noisenames);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_K_Tstnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_SK_E2normal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_SKv3_1normal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Imnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_pasnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Ca_HVAnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Ca_LVAstnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_NaTa_tnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Nap_Et2normal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Ihnormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
...
for Z = 1:30
	...
	noisenames = string(Z)+ string(noisenamebasis)+'.csv';
	namefornoise = '200ms_Noisenormal_IhIm_0.025' + string(noisenames);
	namenoise = 'normal_IhIm_0.025' + string(Z)+ string(noisenamebasis);
