...
from currents_visualization import plotCurrentscape, CurrentValues
...
h.noiserun("1_2andahalfmsNoise_4.000000e-02_3", .01, 2500, 0.031)
...
df_final.to_csv('STA_%s.csv'%namefornoise) 
	

fig0 = plotCurrentscape(vvec0, r0)
#fig0.savefig('PLOTfilescurrent/Currentscape.pdf',dpi=1500) 
fig0.savefig('PLOTfilescurrent/Currentscape.png',dpi=1500)
fig0.clf()
plt.close(fig0)
...
image = Image.open('PLOTfilescurrent/Currentscape.png')
logo = Image.open('PLOTfilescurrent/HorizontalLegend.png')
...
image_copy.save('PLOTfilescurrent/Currentscape_1_2.png')
